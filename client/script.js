...
// CODE HERE
function colorWhiteBlack(mouseover) {
    sayHelloButton.style.background='black';
    sayHelloButton.style.color='white';
}
sayHelloButton.addEventListener("mouseover", colorWhiteBlack)
...
// CODE HERE
function colorBlackWhite(mouseover) {
    sayHelloButton.style.background='#EFEFEF';
    sayHelloButton.style.color='black';
}
sayHelloButton.addEventListener("mouseout", colorBlackWhite)
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get(`${baseURL}/repeat/${'repeat-text'}`)
    .then(function(res){console.log(res.data)})
}
...
// CODE HERE
document.getElementById('query-button').addEventListener('click', querySelector)
function querySelector() {


axios.get(`${baseURL}/query-test/?test=test2`)
.then(function(res){console.log(res.data)})}
